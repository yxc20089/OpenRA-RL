...
class OpenRAEnvironment(MCPEnvironment):
    ...
    def _register_tools(self, mcp: FastMCP) -> None:
        ...
        def configurable_tool(fn):
            ...
            Sync tools are dispatched via asyncio.to_thread() with per-session
            gRPC channels (no shared channel, no HTTP/2 contention).
            """
    ...
    def _action_to_commands(self, action: dict, obs: dict) -> list[CommandModel]:
        ...
        elif tool in ("attack_move", "attack_unit"):
